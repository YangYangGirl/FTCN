	...
	def __getitem__(self,idx):
		...
		while flag:
			try:
				...
				if idx < 20:
					cv2.imwrite("./output/visualization/blend_rgb/img_f" + str(idx) + ".jpg", cv2.cvtColor(img_f, cv2.COLOR_BGR2RGB))
					cv2.imwrite("./output/visualization/blend_rgb/img_r" + str(idx) + ".jpg", cv2.cvtColor(img_r, cv2.COLOR_BGR2RGB))
