...
python test_on_raw_video_CDF.py examples/shining.mp4 output -d CDF -checkpoint output/train_hdf5_v4_base_03_17_11_15_56/weights/22_0.8031_val.tar > logs/test.log 2>&1
